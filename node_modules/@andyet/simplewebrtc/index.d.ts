...
import ChatInput, { ChatInputTextArea } from './components/ChatInput';
...
export { Actions, Audio, Call, Chat, ChatComposers, ChatGroup, ChatInput, ChatInputTextArea, ChatList, Commands, Connected, Connecting, DeviceList, DevicePermissions, Disconnected, Failed, GridLayout, LocalMediaList, Media, MediaControls, NotConnected, Notifications, NotSupported, Peer, PeerConnection, PeerControls, PeerList, Provider, RemoteAudioPlayer, RemoteMediaList, RequestDisplayMedia, RequestUserMedia, Room, RoomConfig, RoomType, Selectors, State, StayDownContainer, User, UserControls, Video, VolumeMeter, reducer };
